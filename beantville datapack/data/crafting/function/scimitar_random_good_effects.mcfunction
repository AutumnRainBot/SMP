...
execute store result score @s scimitar.rng run random value 0..3


execute if score @s scimitar.rng matches 0 run effect give @s minecraft:speed 5 1
execute if score @s scimitar.rng matches 1 run effect give @s minecraft:strength 5 1
